...
class RegisterNewStudentPage extends StatelessWidget {
  const RegisterNewStudentPage({super.key});

  @override
  Widget build(BuildContext context) {
    RegisterNewStudentLogicController logicController = Get.find();
                    ...
                    child: Row(
                      ...
                      children: [
                        Obx(
                          () => IconButton(
                            onPressed:
                                logicController.registerButtonStatus.value ==
