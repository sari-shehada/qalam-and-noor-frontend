...
import 'illness_row.dart';

class IllnessesTable extends StatelessWidget {
  const IllnessesTable({super.key, required this.illnesses});
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return IllnessRow(
                    illness: illnesses[index], rowColor: rowColor);
              },
            ),
          ),
        ]),
