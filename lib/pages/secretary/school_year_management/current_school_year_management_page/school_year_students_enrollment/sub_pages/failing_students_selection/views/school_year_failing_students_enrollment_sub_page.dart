...
import '../controllers/school_year_failing_students_enrollment_sub_page_controller.dart';

class SchoolYearFailingStudentsEnrollmentSubPage
    extends GetView<SchoolYearFailingStudentsEnrollmentSubPageController> {
  const SchoolYearFailingStudentsEnrollmentSubPage({super.key});
