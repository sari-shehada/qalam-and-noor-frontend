...
import '../controllers/school_year_succeeding_students_enrollment_sub_page_controller.dart';
import '../../../shared/views/widgets/student_enrollment_selection_card.dart';

class SchoolYearSucceedingStudentsEnrollmentSubPage
    extends GetView<SchoolYearSucceedingStudentsEnrollmentSubPageController> {
  const SchoolYearSucceedingStudentsEnrollmentSubPage({super.key});
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Obx(
                      () {
                        ...
                        return StudentEnrollmentSelectionCard(
                          student: student,
                          isSelected:
